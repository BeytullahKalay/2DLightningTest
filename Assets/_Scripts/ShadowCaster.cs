...
public class ShadowCaster : MonoBehaviour
{
	...
	[SerializeField] private bool getThinnerOnSides = false;
	...
	private void Update()
	{
		...
		if (col.Length > 0)
		{
			foreach (var c in col)
			{
				...
				var mappedDistance0To1 = Map(Vector2.Distance(transform.position, c.transform.position), 0, detectRadius, 0.1f, 1);
